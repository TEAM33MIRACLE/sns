...
############################################################
    ...
    Coded By    : TEAM33MIRACLE
    Contact Me  : team33miracle@gmail.com
    Date        : 6/5/2018
    Thanks to   : TEAM33MIRACLE
...
print $execute;
?>la/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36');
        $server_output = curl_exec ($ch);
        curl_close ($ch);
		echo $server_output."\n";
        sleep($wait);
